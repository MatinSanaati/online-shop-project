...
export const MenuButton = ({ onClick }) => {
    return (
        <button onClick={onClick} className="menu__button p-4 flex flex-col justify-between items-start bg-blue-500 text-white rounded-md shadow-lg hover:bg-blue-600 transition duration-300">
